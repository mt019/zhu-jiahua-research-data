...
const doc = {
  ...
  materialNature: [
    '底本是朱家驊晚年的談話紀錄。胡頌平在後記寫：「他晚年時常和我談起他生平的事蹟，可以說是他的回憶錄，我都保留住每次談話的紀錄。這裏採取的資料，大部分是根據這種紀錄的。不過他憑記憶記錯的地方也不少，我所知道的，都已設法查明改正了。」（原書 419）編者更正的是他自己知道的錯處，所載的日期與事實仍要與獨立來源核對後才能引用。',
    '朱家驊遺下的檔案交由近代史研究所整理，到 1964 年 2 月只完成兩箱多的目錄，胡頌平寫年譜時原始檔案還不能用（原書 418）。',
    '成書倉促：1964 年 2 月 6 日陳槃提議，5 月底完成初稿約十八萬字，7 月初因紀念論文集篇幅所限重寫成六萬字的簡編。',
  ],
  transcription: {
